...
category — code/documentation/assets, classified by extension — plus a
by-module and by-file-type breakdown that an All/Code/Documentation/
Assets filter narrows to one category), **Repo map** (treemap, area =
lines of code),
