...
.lede{color:var(--dim);max-width:76ch;margin:0 0 20px;text-wrap:pretty}
...
.sum{font-size:14.5px;line-height:1.72;color:#c6ccd4;max-width:88ch;text-wrap:pretty}
...
<head>
<meta charset="utf-8" />
<title>${name} — Repository Report</title>
